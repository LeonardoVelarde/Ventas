...
class DeliveriesControllerTest < ActionController::TestCase
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post :create, delivery: { amount: @delivery.amount, import_id: @delivery.import_id, price: @delivery.price, product_id: @delivery.product_id }
    end
  ...
  test "should update delivery" do
    patch :update, id: @delivery, delivery: { amount: @delivery.amount, import_id: @delivery.import_id, price: @delivery.price, product_id: @delivery.product_id }
    assert_redirected_to delivery_path(assigns(:delivery))
  end
